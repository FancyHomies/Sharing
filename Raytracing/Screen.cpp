...
int Screen::init(int width, int height, const char* title)
{
	WNDCLASS wc = { CS_BYTEALIGNCLIENT, (WNDPROC)WndProc, 0, 0, 0, NULL, NULL, NULL, NULL, "SCREEN" };
	// -height 表示 top-down
	...
	wndHandle = CreateWindow("SCREEN", title, WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX, 0, 0, 0, 0, NULL, NULL, wc.hInstance, NULL);
